	...
	<el-container>
		<el-card class="news" shadow="hover">
			<div class="clearfix" slot="header">
				<div class="container">
					<div class="news-prview">
						...
						<el-button @click="dialogVisible = true" style="float: right" type="warning" v-if="isOwner">
							取消收藏
						</el-button>
						<a class="author" v-bind:href="'/#/minePage?userId='+user.userId" v-if="userVisible">
							{{user.userName }}</a>
					</div>
				</div>
			</div>
			<div class="content clearfix">
				...
				<el-button @click="handleDetail" class="news-detail" style="float: right;" type="text">查看来源
				</el-button>
			</div>
		</el-card>
